...
public class SecuredValue<T> implements ISecuredValue<T> {
    ...
    /**
     * @see com.github.toolarium.process.runner.dto.base.ISecuredValue#getValue()
     */
    @Override
    public T getValue() {
        return value;
    ...
    /**
     * @see com.github.toolarium.process.runner.dto.base.ISecuredValue#hasSecuredValue()
     */
    @Override
    ...
    /**
     * @see com.github.toolarium.process.runner.dto.base.ISecuredValue#getSecuredValue()
     */
    @Override
